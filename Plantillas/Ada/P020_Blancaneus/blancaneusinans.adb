...
procedure Blancaneusinans is
   ...
   begin
      ...
      while monitor.getaDormir < Nre_Nans loop
         if (monitor.getPerMenjar = 0) then
            ...
            delay Retard_Passejar;  --Esperar un momento a volver a mirar si un enano pide

         else  --Si hay un enano
   ...
   begin
      ...
      for I in Positive range Positive'First .. Nre_Menjades loop
         ...
         monitor.demanaCadira; --Entry

         Put_Line(Nom & " ja seu");
         Put_Line(Nom & " espera torn per menjar");
         monitor.demanaMenjar; --Entry
   ...
   Blancaneus : tasca_blancaneus;   --Proceso Blancanieves
   Nan        : Nans;               --Array procesos enanos
